					...
					<div className={`card bjj-card ${currentCard === 'bjj' ? 'active-card' : ''}`} onClick={() => handleClick('bjj')}>
						...
						{currentCard === 'bjj' && (
							<div className='card-content bjj-card-content'>
								...
								<p>In simplest terms, it's fighting someone without the use of striking (punches, kicks, etc.) while also wearing fancy pyjamas (yes you can grab onto them)</p>
								<p>I've been doing it for 4ish years, I'm a purple belt and I compete in international tournaments against the best to test my skills and challenge myself</p>
							</div>
						)}
					</div>
					<div className={`card career-card ${currentCard === 'career' ? 'active-card' : ''}`} onClick={() => handleClick('career')}>
						...
						{currentCard === 'career' && (
							<div className='card-content career-card-content'>
								...
								<p>After graduating, I began to do some research on my own, and tossed myself into this endless world of possibilities, and began my journey on FreeCodeCamp</p>
