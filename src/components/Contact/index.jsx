...
const Contact = () => {
	...
	const sendEmail = (e) => {
		...
		emailjs.sendForm('service_0q8bl8s', 'template_5pw02el', form.current, '62KBAKfc0ivR1Mx0G').then(
			(result) => {
		...
		<div className='container contact-page'>
			<div className='contact-left'>
				<div className='contact-text'>
					<h1>Contact me!</h1>
					<p>
						I'm open to any type of work opportunities. Also, if you have any requests or questions, or even just want
						to chat about something, feel free!
					</p>
				</div>
